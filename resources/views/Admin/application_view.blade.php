            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-tools">
                        <div class="btn btn-sm" data-toggle="modal" type="button" data-target="#SelectApplicants">Shortlist Applicant</div>
                        <div class="modal fade" id="SelectApplicants" tabindex="-1" aria-labelledby="SelectApplicantsLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-body m-3">
                                        <small>
                                            Instruction:<br> Check the box if the applicant passed the Phase 1 shortlisting.
                                        </small>
